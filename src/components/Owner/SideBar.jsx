...
const SideBar = () => {
  ...
  return (
    <div className="relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm">
          ...
          <img className="h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto"
            src={
              image
                ...
                : user?.image ||
                  "https://images.unsplash.com/photo-1740252117070-7aa2955b25f8?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8cHJvZmlsZSUyMGljb258ZW58MHx8MHx8fDA%3D"
            }
            alt="image"
          />
          <input
      ...
      {image && (
        <button onClick={updateImage} className="absolute top-0 right-0 flex p-2 gap-1 bg-primary/10 text-primary cursor-pointer">Save <img src={assets.check_icon} width={13} alt="check" /></button>
      )}
