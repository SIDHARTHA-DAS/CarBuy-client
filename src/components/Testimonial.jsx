...
const Testimonial = () => {
  const cardsData = [
    {
      image:
        "https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=200&q=60",
      name: "Rohan Mehta",
      handle: "@rohan.codes",
    ...
    {
      image:
        "https://images.unsplash.com/photo-1511367461989-f85a21fda167?w=200&q=60",
      name: "Aditya Verma",
      handle: "@aditya_dev",
      date: "March 2, 2025",
    },
    ...
    {
      image:
        "https://images.unsplash.com/photo-1624561172888-ac93c696e10c?w=200&q=60",
      name: "Neha Pandey",
      handle: "@neha.designs",
      date: "June 5, 2025",
    },
    {
      image:
        "https://images.unsplash.com/photo-1544725176-7c40e5a2c9f9?w=200&q=60",
      name: "Manish Kumar",
      handle: "@manish_k",
      date: "July 21, 2025",
    },
  ...
  return (
    <>
      ...
      <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative mt-10 max-md:px-4">
        <Title
          title="What Our Customers Say"
          subTitle={
            "Discover why discerning travelers choose StayVenture for their luxury accommdations around the world"
          }
        />
