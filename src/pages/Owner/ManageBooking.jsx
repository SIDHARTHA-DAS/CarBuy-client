                  ...
                  <tr key={index} className='border-t border-borderColor text-gray-500'>
                    ...
                    <td className='p-3'>
                      {bookings.status === "pending" ? (
                        <select onChange={e=>changeBookingStatus(bookings._id,e.target.value)} value={bookings.status} className='px-2 py-1.5 mt-1 text-gray-500 border border-borderColor rounded-md outline-none'>
